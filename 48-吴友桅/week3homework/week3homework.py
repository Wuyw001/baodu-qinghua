...
class TorchModel(nn.Module):
    def __init__(self, vector_dim, sentence_length, vocab):
        ...
        self.embedding = nn.Embedding(len(vocab), vector_dim)  #embedding层对输入参数编码
...
#abc -> [1,2,3]
def build_vocab():
    chars = "abcdefghijklmnopqrstuvwxyz1234567890中文"  #字符集
    vocab = {}
...
if __name__ == "__main__":
   main()
   test_strings = ["文fvfe中", "w中sdf文", "rq中文bg", "nak中ww","asdfgf","123456"]
